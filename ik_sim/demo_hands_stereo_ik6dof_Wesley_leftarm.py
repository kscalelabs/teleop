...
async def ik(arm: str, max_attempts=20, max_iterations=100) -> float:
    ...
    if arm == "right":
        ...
        joint_damping = [0.00001, 100, 100, 100, 100, 100, 0.00001, 0.00001, 0.0000001, 0.00001, 0.00001]#, 0.1, 0.1]
        ...
        joint_damping = [0.00001, 0.00001, 0.00001, 0.00001, 0.00001, 0.00001, 100, 100, 100, 100, 100]#, 0.1, 0.1]
    ...
    for attempt in range(max_attempts):
        ...
        # Apply the solution to all joints including the torso
...
async def main(session: VuerSession):
    ...
    while True:
        ...
        error_right = "none" #await ik("right")
